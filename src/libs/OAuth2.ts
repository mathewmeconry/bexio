...
export default class OAuth2 {
    ...
    private authorization_uri: string = 'https://office.bexio.com/oauth/authorize'
    private access_token_uri: string = 'https://office.bexio.com/oauth/access_token'
    private refresh_token_uri: string = 'https://office.bexio.com/oauth/refresh_token'
